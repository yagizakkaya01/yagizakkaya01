...
circle-board-game	A 10×10 circular board game with traps and dice mechanics	`C`
crag-dice-game	Implementation of the Crag dice game with full scoring logic	`C`
patient-management-system	Patient records with BMI classification and risk filtering	`C`
internship-records-system	Record management and analysis over internship datasets	`C`
</details>
<br/>
💼 Experience
```
